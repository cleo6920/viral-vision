...
export const BrushIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M10 21.9a10.24 10.24 0 0 1-7.1-3A9.95 9.95 0 0 1 2 12C2 6.5 6.5 2 12 2c6.1 0 11 4.9 11 11v1.5c0 1.5-.8 2-1.5 2S20 16 20 14.5V12c0-4.4-3.6-8-8-8s-8 3.6-8 8 1.9 4.8 4.7 7.1"/>
    <path d="M22 22v-3"/>
  </svg>
);
